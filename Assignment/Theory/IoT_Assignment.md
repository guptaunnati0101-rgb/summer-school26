...
Q1) Smart irrigation system: Arduino UNO vs ESP32
If I have to build a smart irrigation system that reads soil moisture, controls a water pump, and sends data to a mobile application every 5 seconds, I would choose the ESP32.
...
Bluetooth:  Bluetooth or BLE is useful for short‑range communication and low‑power devices, but it is not suitable for plant‑wide communication over 2 km.
